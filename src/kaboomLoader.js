...
// Load fonts
k.loadFont("glyphmesss.ttf", "../assets/glyphmesss.ttf");

// Load sprites, split and animation
k.loadSprite("player", "../assets/sprites/u.png", {
  ...
  anims: {
    ...
    explode: { from: 24, to: 28, speed: 16 },
  },
});
...
// Load ui assets
// LoadSpriteAtlas loads a specific portion of the image
